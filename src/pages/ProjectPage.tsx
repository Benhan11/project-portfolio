        ...
        <div className="min-h-screen font-mono text-slate-400 bg-gradient-to-r from-black via-violet-950 to-black">
            <div className="mx-auto max-w-screen-xl px-6 md:px-12 lg:px-24">
                ...
                {project.dataSections.map((section, index) => 
                    <div ref={sectionsRef.current[index]} className={`lg:flex lg:justify-between pb-36 transition-opacity ease-in duration-200 ${isVisibleArray[index] ? "opacity-100" : "opacity-30"}`}>
