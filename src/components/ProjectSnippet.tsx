...
function ProjectSnippet({ snippet }: SnippetProps) {
    return (
        <Link to={`/project/${snippet.projectId}`}>
            <div className="sm:flex sm:flex-row sm:bg-neutral-900/[0.4] gap-x-10 sm:px-6 py-4 mb-12 text-slate-200 hover:text-slate-100 sm:border border-b border-stone-300 sm:rounded-md rounded sm:shadow-[0px_1px_2px_2px_rgba(0,0,0,0.3)] shadow-[0px_5px_2px_-2px_rgba(0,0,0,0.2)]
                            transition ease-in-out delay-0 duration-200 hover:translate-y-1 sm:hover:scale-[1.01] hover:shadow-[0px_1px_2px_2px_rgba(0,0,0,0.5)] sm:hover:bg-black/25">
